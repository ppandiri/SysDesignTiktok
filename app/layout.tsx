...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      <body>
        {children}
        <script src="/js/data.js?v=1.0.4" defer />
        <script src="/js/storage.js?v=1.0.4" defer />
        <script src="/js/algorithm.js?v=1.0.4" defer />
        <script src="/js/diagrams.js?v=1.0.4" defer />
        <script src="/js/app.js?v=1.0.4" defer />
      </body>
    </html>
  );
}
